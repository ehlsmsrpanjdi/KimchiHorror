...
#include "Data/C_RoomSign.h"
#include "Data/C_DiaryDataTable.h"
...
public:
	...
	UFUNCTION(BlueprintCallable)
	FC_RoomSign GetRoomSignData(FName _RoomSign);

	UFUNCTION(BlueprintCallable)
	FC_DiaryDataTable GetDiaryData(FName _Data);
